...
Fitifact is a proposed **universal file compatibility layer**.
...
Fitifact starts from the user's actual intent:
...
The engine should be **genuinely open**, likely Apache-2.0 for Fitifact-owned code after license review.
...
This is validation but means Fitifact should **not** claim invention of automatic compatibility or content adaptation.
...
1. Name collision: “Fitifact” is already used in software.
