...
Shoehorn does **not** enter an empty market.
...
**Threat**  
Very strong FOSS converter territory. If Shoehorn looks like “a nicer open-source converter,” it is not differentiated.

**Shoehorn difference**  
VERT is primarily conversion-oriented. Shoehorn must own destination constraints, diagnosis and validation.
...
**Difference**  
Shoehorn should not compete on arbitrary format conversion. It should solve “make this work there.”
...
**Difference**  
Shoehorn generalizes around explicit destination constraints, multiple file families, registry and validation.
...
**Difference**  
Shoehorn centers destination constraints and validated acceptance rather than broad optimization.
...
**Difference**  
Shoehorn models arbitrary typed constraints and can choose no-op/selective paths based on each input.
...
### FFmpeg
Foundation for media; not something Shoehorn should reimplement.
...
Shoehorn loses if the primary interaction becomes:

```text
Choose output format.
```

Shoehorn wins only if it consistently starts from:
