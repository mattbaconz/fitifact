...
Explanation:
> Your file is MP4, but the video inside it uses HEVC. This target needs H.264. The file is also too large. Shoehorn will leave the audio untouched.
...
Shoehorn must ask crop vs padding; never crop silently.
